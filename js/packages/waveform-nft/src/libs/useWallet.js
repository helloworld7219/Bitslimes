...
let walletStoreReactive = {}
let walletStore = {}

export const useWalletReactive = () => walletStoreReactive
...
export const initWallet = (autoConnect = false) => {
  ...
  for (const key of Object.keys(_data)) {
    const refProp = walletStoreReactive[key]

    Object.defineProperty(walletStore, key, {
      get () {
        return unref(refProp)
      }
    })
  }
}
